...
![Transakcje](docs/screenshots/transactions.png)
![Wpisy](docs/screenshots/entries.png)
![Kategorie](docs/screenshots/categories.png)
![Raporty](docs/screenshots/reports.png)
![Import CSV](docs/screenshots/import.png)
```
